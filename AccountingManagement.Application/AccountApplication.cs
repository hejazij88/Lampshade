...
namespace AccountingManagement.Application
{
    public class AccountApplication : IAccountApplication
    {
        ...
        public AccountViewModel GetAccountBy(Guid id)
        {
        ...
        public OperationResult Register(RegisterAccount command)
        {
            ...
            if (command.RoleId == Guid.Empty)
                command.RoleId = Guid.Parse("cab27463-bfae-409b-9394-89a41839e727");
            

            var account = new Account(command.Fullname, command.Username, password, command.Mobile, command.RoleId,
                picturePath);
            command.RoleId = new Guid(Roles.Administrator);
        ...
        public EditAccount GetDetails(Guid id)
        {
